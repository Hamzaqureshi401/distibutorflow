...
$(document).ready(function() {
    ...
    $(function() {
        ...
        var monthNames = ["Jan", "Feb", "Mar", "Apr", "May", "June", "July", "Aug", "Sep", "Oct", "Nov", "Dec"];
            ...
            const a = new Date();
            let name = monthNames[a.getMonth()];
            newmonth = newmonth.concat([name]);
            newmonth.reverse();
            var profit = @json($result['data']['subtotal']);
            var actual_profit = @json($result['data']['received_amount']);
            var discounts = @json($result['data']['discounts']);
    ...
    var percentage = @json($result['percentage']['percentage']);
