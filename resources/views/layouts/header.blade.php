<nav class="navbar header-navbar pcoded-header">
   <div class="navbar-wrapper">
      <div class="navbar-logo">
         ...
         <a href="index.html">
         <img class="img-fluid" src="{{ asset('gif/distributor full white logo 167 33-01.png') }}" alt="Theme-Logo" />
         </a>
      ...
      <div class="navbar-container container-fluid">
         <ul class="nav-left">
            ...
            <li>
               <a href="#!" class="btn btn-danger btn-round " onclick="javascript:toggleFullScreen()">
               <i class=""> Error Reporting OR Customization</i>
               </a>
            </li>
            <li>
               <a href="#!" class="btn btn-success btn-round " onclick="javascript:toggleFullScreen()">
               <i class=""> Have Project? Share Us</i>
               </a>
            </li>
         </ul>
         <ul class="nav-right">
