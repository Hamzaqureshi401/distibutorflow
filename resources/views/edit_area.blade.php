...
<div class="page-header card">
         <div class="card-block">
            <h5 class="m-b-10 text-center">Chnage Areas</h5>
            <p class="text-muted m-b-10 text-center">Update Area Name</p>
...
<div class="row">
  <div class="col-md-6 m-auto">
    <div class="card mb-3">
      ...
      <div class="card-body">
        <form method="post" action="{{ route('update.area', $area->id)  }}" onsubmit="disableButton()">
          {{ csrf_field() }}
          ...
          <button id="button" type="submit" class="btn btn-primary btn-block call-processing">Update Area</button>
        </form>
      </div>
    </div>
  </div>
