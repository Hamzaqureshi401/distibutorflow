...
<!-- Breadcrumbs-->
      ...
      <div class="page-header card">
         <div class="card-block">
            <h5 class="m-b-10 text-center">Create Customer Invoice</h5>
            <p class="text-muted m-b-10 text-center">Select Customer for Invoice</p>
      ...
      <div class="card-body">
        <form method="post" action="{{ route('store.invoice') }}" id="invoice-form" onsubmit='disableButton()'>
          ...
          <div class="form-group">
              <center>
            <select class="search" name="customer_id" style="width: 300px" id="customer-id" required="" data-placeholder="Choose a customer...">
          ...
          <div class="form-group c-selected" style="display: none">
            ...
            <input type="text" class="search form-control" placeholder="Search product ...">
              ...
              <table class="table table-bordered table-custom-th table-hover table-bordered results" width="100%" cellspacing="0">
                <thead>
                  <tr>                    
                    <th>Name</th>
                    <th>Price</th>
          ...
          <div class="row create-invoice-section" id="create-section">
            ...
            <div class="form-group col-md-6">
              ...
              <input class="form-control r-amount" id="r-amount" type="number" name="received_amount" value="0">
            </div>
            @if(Auth::user()->role < 3)
            <div class="form-group col-md-6">
...
$(document).ready(function() {
 ...
 @include('ajax.run_time_update_product_price')
</script>
@endpush