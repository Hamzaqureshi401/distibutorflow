                        ...
                        <form class="md-float-material" id="login" method="post" action="{{ route('login') }}"> 
                            ...
                            <div class="auth-box">
                                ...
                                <div class="input-group">
                                    <input type="email" id="exampleInputEmail1" class="form-control" placeholder="Your Email Address" name="email" value="demo@distributorflow.com">
                                    <span class="md-line"></span>
                                </div>
                                <div class="input-group">
                                    <input type="password" id="exampleInputPassword1" class="form-control" placeholder="Password" name="password" value="12345678">
                                    <span class="md-line"></span>
                                </div>
