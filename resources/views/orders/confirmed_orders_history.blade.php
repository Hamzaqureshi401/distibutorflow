...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active">Processed Seller Confirmed Orders  <a href="{{ route('unconfirmed.orders') }}" class="btn btn-sm btn-primary">Go To Unconfirmed Orders</a></li>
</ol>
<div class="row">
  <div class="col-md-12">
    <div class="card mb-3">
          ...
          <table class="table table-bordered table-custom-th" id="dataTable" width="100%" cellspacing="0">
            ...
            <tbody>
             ...
             @endif
                ...
                <td>
                @if(Auth::user()->role < 3 && $order->pick_order == 0)
                ...
                @elseif (Auth::user()->role == 3 && $seller_data->assign_order == 1 && $order->pick_order == 0)
                  <label class="btn btn-default btn-sm check-show-all-orders">
                    <input type="checkbox" name="confirm-to[]" value="{{ $order->id }}" class="approve-to" />
                  </label>
                ...
                @if(Auth::user()->role < 3)
                <br>
                  <a onclick="UseStock({{ $order->id }})" class="btn-primary "><span>Use Stock</span></a>
                  <br>
                ...
                <br>
                    ...
                    <label class="btn btn-default btn-sm">
                      ...
                      <span>Map view</span><br><input type="checkbox" value="{{ $order->customers->location_url }}" data-rowid="{{ $order->id }}" class="add-coords js-switch check-unvisited" />
                 </label>
                 <br>{{ $order->order_date }}
