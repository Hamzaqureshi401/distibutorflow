...
<div class="page-header card">
         <div class="card-block">
            <h5 class="m-b-10 text-center">Seller orders</h5>
            <p class="text-muted m-b-10 text-center">Delivered Orders</p>
           <!--  <ul class="breadcrumb-title b-t-default p-t-10">
            ...
            <div class="card-header">
             ...
             <form method="get" action="{{ route('seller.orders', ['ot_id' => $seller->id]) }}">
    <div class="row">
...
<div class="row">
  <div class="col-md-12">
    <div class="card mb-3">
      <div class="card-header">
        <i class="fa fa-table"></i> <b>{{ $seller->name }}</b> Orders List</div>
      <div class="card-body">
