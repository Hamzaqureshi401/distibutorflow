...
<!-- Breadcrumbs-->
 <div class="page-header card">
         <div class="card-block">
            ...
            <p class="text-muted m-b-10 text-center">Update Seller</p>
...
<div class="row">
  <div class="col-md-6 m-auto">
    <div class="card mb-3">
      <div class="card-header">
        <i class="fa fa-user"></i> Update Seller Details
      </div>
      <div class="card-body">
        <form id="myform">
          {{ csrf_field() }}
          <div class="d-none">
            <input type="hidden" name="id" value="{{ $GetCustomerSeller->id }}">
          </div>
          <div class="form-group">
            <label>Name <span style="opacity: 0.5; font-style: italic;">(Required)</span></label>
            <input class="form-control" type="text" placeholder="Enter Name" name="name" required value="{{ $GetCustomerSeller->name }}">
          </div>
          <div class="form-group">
            <label>Email <span style="opacity: 0.5; font-style: italic;">(Required)</span></label>
            <input class="form-control" id="email" type="email" placeholder="Enter Email" name="email" required  value="{{ $GetCustomerSeller->email }}">
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="number" placeholder="Enter Phone Number" name="phone" required value="{{ $GetCustomerSeller->phone }}">
          </div>
...
var total = 0;
    ...
    function finduser(argument) {
      ...
      $.ajax({
            ...
            url: '{{ route('find.user') }}',
            data:{
              _token: "{{ csrf_token() }}", 'email': argument , 'id': @json($GetCustomerSeller->id)},
