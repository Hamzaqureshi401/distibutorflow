...
<div class="row">
  <div class="col-md-6 m-auto">
    <div class="card mb-3">
      ...
      <div class="card-body">
        <form method="post" action="{{ route('add.remove.customer.stock') }}" id="invoice-form" onsubmit='disableButton()'>
          {{ csrf_field() }}
   ...
   $('#customer-id').on('change' , function(){
    ...
    console.log(cdetails[0]);
      if($(this).val() != ''){
        ...
        $.get('{{ route("find.customer.stock.product") }}/' + cdetails[0] , function(data){
