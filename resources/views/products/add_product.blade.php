      ...
      <div class="card-body">
        <form id="myform">
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control p-price calculate-price" placeholder="Enter Purchase Price" name="p_price" value="0">
          </div>
           <div class="form-group">
          ...
          <div class="form-group">
            <label>Customer Benefit <span style="opacity: 0.5; font-style: italic;">(Auto Calculated)</span></label>
            <input type="number" class="form-control c-ben"  placeholder="Enter Customer Benefit" name="c_benefit" value="0">
          </div>
         
          <div class="form-group">
            <label>Order Taker Benefit</label>
            <input type="number" class="form-control"  placeholder="Enter Order Taker Benefit" name="ot_benefit" id="ke" value="0">
          </div>
          <div class="form-group">
            <label>Admin Benefit <span style="opacity: 0.5; font-style: italic;">(Auto Calculated)</span></label>
            <input type="number" class="form-control a_ben"  placeholder="Enter Admin Benefit" name="a_benefit" value="0"  >
          </div>
