@extends('layouts.app')
@section('title') Sub Admin Invoices @endsection
@section('content')
...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active">Sub Admin Invoices</li>
</ol>
<div class="row">
  <div class="col-md-12">
    <div class="card mb-3">
      <div class="card-header">
        <i class="fa fa-table"></i> <b>{{ $sub_admin->name }}</b> Invoices List</div>
      <div class="card-body">
      ...
      <div class="card-footer small text-muted">Total: <b>{{ $invoices->sum('amount') }}</b> <span class="pull-right">Sub Total: <b>{{ $invoices->sum('received_amount') }}</b></span></div>
    </div>
  </div>
</div>
